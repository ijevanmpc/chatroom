...
/**
 * This class is used for creating an adapter
 * 
...
public class CatalogAdapter extends BaseAdapter {
	...
	/**
	 * Forms for the position to position View, responsible for displaying the
	 * string in the list. This method is the template elements are assigned
	 * specific values ​​of the dataset.
	 */
